...
export default function Home() {
    return (
        <div style={{ fontFamily: 'Courier New, monospace', color: '#00FF00', backgroundColor: '#FFFFE0', padding: '10px', textAlign: 'center' }}>
            ...
            <p><a href="/leadership-principles" style={{ color: '#0000FF', textDecoration: 'underline' }}>Learn More</a></p>
            <h3>Latest Events</h3>
            ...
            <p><a href="/project/browserhack----revolutionizing-productivity-with-innovative-tools" style={{ color: '#8A2BE2' }}>Learn more about our events!</a></p>
            ...
            <p><a href="/fellow-membership" style={{ color: '#FF00FF', textDecoration: 'none' }}>DISCOVER</a> <a href="/our-members" style={{ color: '#FF00FF', textDecoration: 'none' }}>OUR FELLOWS</a></p>
